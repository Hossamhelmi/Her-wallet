...
import 'package:her_wallet/features/adds_hub/presentation/widgets/product.dart';

class AddsHubScreen extends StatelessWidget {
  const AddsHubScreen({super.key});
        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: BlocBuilder<HerSouqCubit, HerSouqState>(
