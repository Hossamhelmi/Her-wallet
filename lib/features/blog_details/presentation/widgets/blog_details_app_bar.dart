...
class BlogDetailsAppBar extends StatelessWidget implements PreferredSizeWidget {
  final Function(String)? onSearchChanged;

  const BlogDetailsAppBar({super.key, this.onSearchChanged});
  ...
  Widget build(BuildContext context) {
    return AppBar(
      ...
      title: Text(
        context.localizations.blogDetails,
        style: TextStyle(
          fontSize: 18.sp,
